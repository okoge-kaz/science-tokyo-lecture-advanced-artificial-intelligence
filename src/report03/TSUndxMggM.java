...
/**
 * This program executes UNDX+MGG three trials, changing a random seed. It saves a transition of the
 ...
 * 1e-7 - Log filename: UndxMggKTabletP14K5.csv
 *
 * @author isao
 */
public class TSUndxMggM {
  ...
  private static void executeOneTrial(
      TSUndxMgg ga, long maxEvals, TCTable log, String trialName, int trialNo) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    TSUndxMgg ga =
        new TSUndxMgg(minimization, dimension, populationSize, noOfKids, random); // REX/JGG
