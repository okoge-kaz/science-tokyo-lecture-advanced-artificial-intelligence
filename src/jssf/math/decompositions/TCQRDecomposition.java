...
/**
 * QR分解クラス． Jama.QRDecompositionを元に作成． TCMatrix用に改変． 再配布にはライセンス注意． 20100822 取りあえず作成．コードをきれいにするのは後．
 *
 * @author uemura
 *     <p>QR Decomposition.
 *     <p>For an m-by-n matrix A with m >= n, the QR decomposition is an m-by-n orthogonal matrix Q
 *     and an n-by-n upper triangular matrix R so that A = Q*R.
