...
public abstract class TCAbstractRandom implements ICRandom {
  ...
  /**
   * Returns a random bit sequence of the specified bits packed into an {@code int} value, assuming
   * the lower {@code bits} bits are uniformly-random (probabilities of being 0 or 1 are equal) and
   * the upper {@code (32 - bits)} bits are zero.
   *
