...
public interface ICRandom extends Serializable {
  ...
  /**
   * Returns a {@code boolean} value uniformly distributed on the range of {@code boolean} using the
   * next value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code boolean} value distributed on the range of {@code boolean} using the next
   * value of the random number sequence in this object. The probability to return {@code true} and
   * {@code false} is (approximately) {@code pTrue} and {@code 1 - pTrue}, respectively. We
   * necessarily ensure the following two conditions;
   *
   * <ul>
  ...
  /**
   * Returns a {@code char} value uniformly distributed on the range of {@code char} using the next
   * value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code byte} value uniformly distributed on the range of {@code byte} using the next
   * value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code short} value uniformly distributed on the range of {@code short} using the
   * next value of the random number sequence in this object.
   *
  ...
  /**
   * Returns an {@code int} value uniformly distributed on the range of {@code int} using the next
   * value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code long} value uniformly distributed on the range of {@code long} using the next
   * value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code float} value uniformly distributed on the closed-open interval {@code [0.0f,
   * 1.0f)} using the next value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code float} value uniformly distributed on the closed-open interval {@code [0.0f,
   * sup)} using the next value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code double} value uniformly distributed on the closed-open interval {@code [0.0d,
   * 1.0d)} using the next value of the random number sequence in this object.
   *
  ...
  /**
   * Returns a {@code double} value on the standard Gaussian distribution (i.e. its mean is 0 and
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code boolean}.
   *
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated so
   * that the probability to generate {@code true} and {@code false} is (approximately) {@code
   * pTrue} and {@code 1 - pTrue}, respectively. We necessarily ensure the following two conditions;
   *
   * <ul>
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code char}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed interval {@code [0, n-1]}.
   *
   * @param buf a buffer to be filled with random numbers
   * @param n the number of possible values
   * @since 27 hmkz
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed interval {@code [min, max]}.
   *
   * @param buf a buffer to be filled with random numbers
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code byte}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code short}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code int}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the range of {@code long}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed-open interval {@code [0.0f, 1.0f)}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed-open interval {@code [0.0f, sup)}.
   *
   * @param buf a buffer to be filled with random numbers
   * @param sup the supremum of random numbers (exclusively)
   * @since 30 hmkz
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed-open interval {@code [0.0d, 1.0d)}.
   *
   * @param buf a buffer to be filled with random numbers
   * @since 27 hmkz
   */
  ...
  /**
   * Fills the specified array {@code buf} with random numbers. The random numbers are generated
   * (approximately) uniform-randomly on the closed-open interval {@code [0.0d, sup)}.
   *
   * @param buf a buffer to be filled with random numbers
   * @param sup the supremum of random numbers (exclusively)
   * @since 30 hmkz
  ...
  /**
   * Shuffles the specified array {@code a} destructively. The order of the elements in the
   * resulting array are guaranteed to be (approximately) uniform-random for any given array {@code
   * a} .
   *
   * @param a an array to be shuffled. The resulting array is returned by overwriting this array
   * @since 27 hmkz
   */
  void shuffle(boolean[] a);

  /**
   * Shuffles the first {@code n} elements in the specified array {@code a} destructively. For any
   * given array {@code a}, the order of the elements in the resulting array are guaranteed that the
   * first {@code n} elements' is (approximately) uniform-random and the others' equals to the
   * original's.
   *
   * @param a an array to be shuffled. The resulting array is returned by overwriting this array
  ...
  /**
   * Shuffles the elements of the specified array {@code a} placed between {@code begin} and {@code
   * end} destructively. For any given array {@code a}, the order of the elements in the resulting
   * array are guaranteed that the elements' between {@code begin} and {@code end} is
   * (approximately) uniform-random and the others' equals to the original's.
   *
   * @param a an array to be shuffled. The resulting array is returned by overwriting this array
  ...
  /**
   * Shuffles the specified list destructively. The order of the elements in the resulting list are
   * guaranteed to be (approximately) uniform-random for any given list {@code list}.
   *
   * @param list a list to be shuffled. The resulting list is returned by overwriting this list
   * @since 27 hmkz
   */
  void shuffle(List<?> list);

  /**
   * Shuffles the first {@code n} elements in the specified list destructively. For any given list
   * {@code list}, the order of the elements in the resulting list are guaranteed that the first
   * {@code n} elements' is (approximately) uniform-random and the others' equals to the original's.
   *
   * @param list a list to be shuffled. The resulting list is returned by overwriting this list
   * @param n the number of elements to be shuffled
   * @since 27 hmkz
   ...
   * destructively. For any given list {@code list}, the order of the elements in the resulting list
   * are guaranteed that the elements' between {@code begin} and {@code end} is (approximately)
