...
/**
 * This program executes REX/JGG three trials, changing a random seed.
 ...
 * - Log filename: RexJggOffsetKTabletP14K5.csv
 * 
 * @author isao
 *
 */
public class TSRexNJggM {
	...
	public static void main(String[] args) throws IOException {
		...
		String trialName = "RexJggOffsetKTabletP14K5"; //The trial name, which is used for the log filename.
