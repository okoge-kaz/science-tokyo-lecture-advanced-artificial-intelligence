...
public class TSArexJgg implements Serializable {
	...
	public TCSolutionSet<TSRealSolution> makeOffspring() {
		...
		fReproductionSelection.doIt(fPopulation, fArex.getNoOfParents(), fParents); //Executes mating selection.
		fArex.makeOffspring(fParents, fNoOfKids, fKids);  //Executes AREX to generates offspring.
		return fKids;
	}
	
	/**
	 * Adapts the expansion ratio of AREX and executes survival selection
	 */
	public void nextGeneration() {
		fArex.updateExpansionRate(); //Adapts the expansion ratio of AREX.
