...
public interface ICReproductionSelection<X extends ICSolution> extends Serializable {
  ...
  /**
   * 親個体の選択を行う． 復元抽出の場合は，population内の個体のコピーをparentsに登録する． 非復元抽出の場合は，populationから削除した個体をparentsに登録する．
   * {@code parents} に抽出された親集団が格納される． {@code parents} は始めに{@code clear()} されること．
   *
   * @param population 集団
