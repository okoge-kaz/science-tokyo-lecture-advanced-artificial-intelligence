...
public class TSUndxMgg implements Serializable {
  ...
  public TCSolutionSet<TSRealSolution> initialize() {
    ...
    fSurvivalSelection =
        new TCBestAndRankBasedRouletteSelectionFromFamily<TSRealSolution>(fComparator, fRandom);
  ...
  public TCSolutionSet<TSRealSolution> makeOffspring() {
    ...
    fReproductionSelection.doIt(
        fPopulation, fUndx.getNoOfParents(), fParents); // Executes mating selection.
