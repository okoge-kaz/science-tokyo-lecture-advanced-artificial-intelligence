...
public class TSRexNJgg implements Serializable {
	...
	public TCSolutionSet<TSRealSolution> makeOffspring() {
		...
		fReproductionSelection.doIt(fPopulation, fRex.getNoOfParents(), fParents); //Executes mating selection.
		fRex.makeOffspring(fParents, fNoOfKids, fKids); //Executes REX to generates offspring.
		return fKids;
	}
	...
	public void nextGeneration() {
		fSurvivalSelection.doIt(fPopulation, fParents, fKids); //ê∂ë∂ëIëÇçsÇ§ÅD
	}
