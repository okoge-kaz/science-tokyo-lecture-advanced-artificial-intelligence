...
public class TCArex<X extends ICRealSolution> implements Serializable {
  ...
  /** なお，[秋本 09]によると， AREX+JGGにおける生成子個体数の推奨値は次元 <i>n</i> に対して <tt>noOfKids</tt> = <i>4n</i> である． */
  ...
  /** 拡張率適応を実行する． doItを呼んで，kidsを生成して，kidsを評価した後に呼び出すこと． */
