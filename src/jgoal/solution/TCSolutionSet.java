 ...
 * @author isao
 */
public class TCSolutionSet<X extends ICSolution> extends ArrayList<X>
  ...
  /**
   * Creates an empty, unresizable solution set. Be careful to use the objects from this
   * constructor; they do not have a solution factory and we have to set it before a call to {@link
   * #resize(int)}.
   *
   * @since 2 isao
   */
   ...
   * @since 2 isao
   */
  public TCSolutionSet(@ACParam(key = "SolutionTemplate") X solutionTemplate) {
  ...
  /**
   * Deep-copies the specified solution set to this object. Each content of the argument is
   * deep-copied.
   *
  ...
  /**
   * Changes the size of this solution set. When the size gets shrinked, the exceeding number of
   * solutions are truncated from the tail of the set. Contrarily, if the size gets increased, the
   * new initialized solutions are attached to the tail. It is guaranteed that the solutions placed
   * in front of them are invariant during this operation.
   *
