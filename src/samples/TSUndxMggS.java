...
/**
 * This program executes UNDX+MGG one trial. - Benchmark function: k-tablet (k=n/4). - Dimension:
...
public class TSUndxMggS {
  ...
  public static void main(String[] args) {
    ...
    TSUndxMgg ga =
        new TSUndxMgg(minimization, dimension, populationSize, noOfKids, random); // UNDX+MGG
