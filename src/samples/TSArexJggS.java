...
/**
 * This program executes AREX/JGG one trial. - Benchmark function: k-tablet (k=n/4). - Dimension:
 * n=20. - Initial region: [-5,+5]^n， - Population size: 14n - The number of offspring: 5n - The
 * maximum number of evaluation: 4n x 1e4 - The evaluation value for termination: 1.0 x 1e-7
 *
 * @author isao
 */
public class TSArexJggS {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        noOfEvals + " " + best); // Displays the best evaluation value in the population.
    while (best > 1e-7
        && noOfEvals
